      ...
      <div class="row">
          ...
          <div class="col-md-8 col-lg-9">
            <div class="text-heading" style="margin-top: 20px;">
                <h2 class="h2 text-uppercase">LOADING SERVICES</h2>

            </div>
            <div class="p-1">
                    <p class="text-cont">AFG is well equipped with the best man power, 
                        tools and machineries to meet your loading and unloading 
                        requirements. We understand that little negligence in loading
                         and unloading the goods can cause unrecoverable damage.  To 
                         avoid unforeseen situations, we carefully study the scenario 
                         and plan the loading and unloading task wisely.</p>
                            <div class="mb-35">
                              <div class="ask">
                                <p class="list-text"><i class="fas fa-check-square"></i>Packing/unpacking facility</p>
                                <p class="list-text"><i class="fas fa-check-square"></i>Careful loading/unloading of items</p>
                                <p class="list-text"><i class="fas fa-check-square"></i>Full moving consultancy</p>
                                <p class="list-text"><i class="fas fa-check-square"></i>Transparent moving solutions</p>
                                <p class="list-text"><i class="fas fa-check-square"></i>Shipment Monitoring and Project Management</p>
                             </div>
                            </div>                
            </div>
            <div class="text-heading" style="margin-top: 20px;">
            ...
            <div class="p-1">
               <p class="text-cont">
                We have a reputation of carrying out all the loading and unloading
                projects with utmost care and perfection. Our work force is well 
                equipped to handle all the complications that may arise in the process.
               </p>
            </div>
