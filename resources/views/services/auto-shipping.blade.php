      ...
      <div class="row">
          ...
          <div class="col-md-8 col-lg-9">
            <div class="text-heading" style="margin-top: 20px;">
                <h2 class="h2 text-uppercase">Ocean Transportation</h2>

            </div>
            <div class="p-1">
                    <p class="text-cont">Choosing an experienced auto shipping company is vital when it comes to 
                        shipping your vehicles to different locations. AFG is an experienced
                         automobile shipping company offering variety of options for the clients 
                         to choose from. We make the client understand the pros and cons of each
                          of these options to help them make sound decisions. We strap the vehicles
                           with modern techniques to ensure less vibration during the movement. 
                           We have multi vehicle carriers to facilitate bulk transportation without
                            compromising on security.</p>
                            <div class="mb-35">
                              <div class="ask">
                                <p class="list-text"><i class="fas fa-check"></i>Drive Away</p>
                                <p  class="list-text"><i class="fas fa-check"></i>Open Carrier transportation</p>
                                <p class="list-text"><i class="fas fa-check"></i>Closed Carrier transportation</p>
                                <p class="list-text"><i class="fas fa-check"></i>National and International vehicle transportation</p>
                             </div>
                            </div>                
            </div>
            <div class="text-heading" style="margin-top: 20px;">
