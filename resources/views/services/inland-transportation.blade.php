      ...
      <div class="row">
          ...
          <div class="col-md-8 col-lg-9">
            <div class="text-heading" style="margin-top: 20px;">
                <h2 class="h2 text-uppercase">INLAND TRANSPORTATION</h2>

            </div>
            <div class="p-1">
                    <p class="text-cont">By road or barge, our flexible and reliable 
                        inland transportation services include both LCL (low container 
                        load) and HCL (High container load). We ensure your commodities
                         are delivered at the destinations on time. We also offer reliable
                          and trustworthy warehouses to let you store your commodity for 
                          a period of time during the movement.</p>
                            <div class="mb-35">
                              <div class="ask">
                                <p class="list-text"><i class="fas fa-check-square"></i> From seaport to inland destination</p>
                                <p class="list-text"><i class="fas fa-check-square"></i>From airport to inland destination</p>
                                <p class="list-text"><i class="fas fa-check-square"></i>Any Inland origin to sea Port or airport</p>
                                <p class="list-text"><i class="fas fa-check-square"></i> Combined transportation by barge</p>                           </div>
                            </div>                
            </div>
            <div class="text-heading" style="margin-top: 20px;">
            ...
            <div class="p-1">
               <p class="text-cont">
                ...
                global associations. We have access to global shipping networks, ware houses 
                and good connections in freight forwarding industry. Such associations enable
                 us to come up with competitive prices. We have experienced and well trained
                  staffs dedicated to offer excellent service and quick responses to all calls, 
                  mails and messages – we understand that effective communication is an absolute.
               </p>
            </div>
